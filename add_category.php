...
<body>
    <div class="container">
        ...
        <form class="shadow p-4 rounded-0 mt-5" style="width: 90%; max-width: 50rem;" action="php/add-category.php" method="post">
            ...
            <button type="submit" class="btn btn-primary rounded-0">Add Category</button>
        </form>
    </div>
